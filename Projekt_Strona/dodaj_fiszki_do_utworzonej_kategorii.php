...
echo "<form method=post action=dodaj_fiszki_do_utworzonej_kategorii.php>";
...
/////////////////////////////3. dodajemy fiszki ///////////////////////////////////////////////////
if(isset($_POST["frm_flash_term"]) && isset($_POST["frm_flash_def"])) //jelsi dodaj_fiszki_do_utworzonej_kategorii.php nie byl uruchomiony po raz pierwszy
    {
        ...
        if($result){//jeśli się udało
            header("Location: dodaj_fiszki_do_utworzonej_kategorii.php"); //tu załadujemy stronę od nowa, żeby wyświetlić dodaną fiszkę
        }
        else{
